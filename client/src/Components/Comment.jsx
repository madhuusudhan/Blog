                    ...
                    </div>
                    {
                        currentUser?._id === comment.userId && (
                            <div className='flex space-x-2'>
                                <Button size="xs" color="gray" onClick={handleEdit}>
                                    Edit
                                </Button>
                                <Button size="xs" color="failure" onClick={() => onDelete(comment._id)}>
                                    Delete
                                </Button>
                            </div>
                        )
                    ...
                    isEditing ? (
                        <>
                            ...
                            <div className='flex justify-end space-x-2 mt-2'>
                                <Button size="xs" color="gray" onClick={() => setIsEditing(false)}>
                                    Cancel
                                </Button>
